        ...
        <div className="flex h-[455px] flex-col bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700">
          ...
          <div className="mb-5 ml-5 flex justify-between">
            ...
            <button
              ...
              className="inline-flex gap-2 mr-5 items-center px-3 py-2 text-xl  font-bold text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 inter"
            >
              Delete
              <svg
                className=" w-9 h-9  pb-1"
